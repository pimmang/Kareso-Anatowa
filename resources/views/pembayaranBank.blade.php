    ...
    <div class="contain d-flex justify-content-center ">
        <div class="container d-flex justify-content-center align-items-center my-5">
            <div class="card mb-5" style="width: 20rem;">
                ...
                <div class="card-body">
                    <h3 class="card-title mb-3">Bank Transfer</h3>
                    <p class="card-text">BRI : 501401023989534 a.n Firman</p>
                    <p class="card-text">BCA : 8735662836 a.n Firman</p>
                    <p class="card-text">BTPN : 90320208551 a.n Firman</p>
