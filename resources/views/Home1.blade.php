...
@section('main')
    @guest
        <div class="container-fluid">
            <img src="img/Banner4.png" alt="Banner" id="banner2" class="shadow-sm">
            <img src="img/Banner4.png" alt="Banner" id="banner3" class="shadow-sm">
        </div>
    @else
        <div class="container-fluid">
            <img src="img/Banner4.png" alt="Banner" id="banner2" class="shadow-sm">
    ...
    <div class="container-fluid justify-content-center">
        <div id="menu-kategori" class="container-fluid d-flex ms-0">
            ...
            <form action="/home" method="post" id="item-kategori" class="container p-0">
        ...
        <div id="daftar-produk"class="container d-flex flex-row flex-wrap justify-content-center ">
            @if (count($barang) > 0)
                ...
                @endforeach
            @else
                <h4 style="font-family: 'Play', sans-serif; color: #51b19d;text-align:center; margin-top:3%"> Barang Dengan
                    Kategori
